...
public class Main
{
  ...
  {
//    int test2 = PokerUtil.evaluateHand(new Card[]{new Card(9,0),new Card(11,0),new Card(13,0),
//                                     new Card(9,1),new Card(2,2),new Card(5,3),new Card(14,3)});
//    //System.out.println(test2);
//    
//    int test = PokerUtil.evaluateHand(new Card[]{new Card(9,0),new Card(11,0),new Card(13,0),
...
//   // System.out.println(test);
    ...
    {
      t.setPlayer(seat, new Player(new RandomStrategy(), 1000));// <-----NUMBER OF CHIPS
    }
